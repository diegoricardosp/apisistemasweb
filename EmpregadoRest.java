...
/*
	...
	@Path("{ativos}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response listarEmpregadosAtivos(@PathParam("ativo") boolean ativo) throws Exception {
	...
	@Path("{inativos}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response listarEmpregadosInativos(@PathParam("ativo") boolean ativo) throws Exception {
